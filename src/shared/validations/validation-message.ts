...
export function isPositiveValidationOptions(
    ...
    return {
      message: 'El número $property debe ser un positivo',
    };
  }
...
export function isIntValidationOptions(
  ...
  return {
    message: 'La propiedad $property debe ser un integer',
  };
}
...
export function arrayNotEmptyValidationOptions(
    validationOptions?: ValidationOptions,
  ) {
    return {
      message: 'El array $property no debe estar vacío',
    };
}